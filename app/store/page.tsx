                    ...
                    {products.map((item, i) => (
                        ...
                        >
                            <div className="aspect-square bg-neutral-50 relative flex items-center justify-center p-8">
                                ...
                                <div className="w-40 h-40 rounded-full border border-dashed border-neutral-300 flex items-center justify-center text-neutral-300 font-dot text-2xl group-hover:border-black group-hover:text-black transition-colors text-center p-2">
                                    {item.name.split(' ')[0]}
                                </div>
                            </div>
                            <div className="p-6 border-t border-neutral-200 flex flex-col flex-grow">
                                ...
                                <p className="text-sm text-neutral-500 mb-4 flex-grow">{item.description}</p>
                                <button
                                    onClick={() => addToCart(item)}
                                    className="w-full py-3 bg-black text-white text-sm font-medium rounded hover:bg-neutral-800 transition-colors active:scale-95 transform"
                                >
                                    ADD TO CART
                                </button>
                            </div>
